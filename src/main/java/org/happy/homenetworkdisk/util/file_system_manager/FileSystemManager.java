package org.happy.homenetworkdisk.util.file_system_manager;
 ...
 * （可能会有一定的耗时）。
 * 每次使用前都请手动调用FileNodeUtil.initNodeTableToDataBase()方法以确保节点链接最新。
 * </p>
 *
 * @version 1.0
 */
public class FileSystemManager {
     ...
     * </p>
     *
     * @return file_system_manager.FileSystemManager 唯一实例
     */
     ...
     * @return file_system_manager.pojo.FolderView 指定的文件夹视图
    ...
    // 留档功能，应与FileBlockUtil.saveToRecycleBin(File, String, String, boolean)相同
