    ...
    private void writeToLog(String type, String content) {
        ...
        try {
            ...
            if (Printer.instance != null) {
                Printer.instance.print("HomeNetWorkDiskIFT:[Log]Cannt write to file,message:" + e1.getMessage());
            } else {
                System.out.println("HomeNetWorkDiskIFT:[Log]Cannt write to file,message:" + e1.getMessage());
            }
        }
    }
