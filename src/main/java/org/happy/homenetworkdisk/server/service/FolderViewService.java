 ...
 * 该服务层用于查询、拼装、处理文件夹视图的相关请求，是HomeNetWorkDisk核心功能的主要组成之一。
 * </p>
 *
 * @version 1.0
 */
public interface FolderViewService{
	 ...
	 * @param request 请求对象
	 * @return java.lang.String 该文件夹视图的JSON格式，原型详见FolderView类。
	 */
     ...
     * @return java.lang.String 该文件夹视图的JSON格式，原型详见SreachView类。
     */
     ...
     * @return java.lang.String 该文件夹后续视图的JSON格式，原型详见RemainingFolderView类。
     */
