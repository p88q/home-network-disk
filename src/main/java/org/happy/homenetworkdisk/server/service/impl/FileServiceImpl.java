...
import org.happy.homenetworkdisk.server.pojo.CheckImportFolderRespons;
import org.happy.homenetworkdisk.server.pojo.CheckUploadFilesRespons;
import org.happy.homenetworkdisk.server.service.FileService;
...
public class FileServiceImpl extends RangeFileStreamWriter implements FileService {
    ...
    public void downloadCheckedFilesZip(final HttpServletRequest request, final HttpServletResponse response)
        ...
        if (zipname != null && !zipname.equals("ERROR")) {
            ...
            String fname = "HomeNetWorkDisk_" + ServerTimeUtil.accurateToDay() + "_\u6253\u5305\u4e0b\u8f7d.zip";
            if (zip.exists()) {
