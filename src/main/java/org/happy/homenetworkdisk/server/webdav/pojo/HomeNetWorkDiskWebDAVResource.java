package org.happy.homenetworkdisk.server.webdav.pojo;
 ...
 * <p>
 * 该类用于将HomeNetWorkDisk中的文件或文件夹封装为一个抽象的“资源”以便进行统一处理，避免文件和文件夹区分处理带来的代码混乱。
 * </p>
 *
 * @version 1.0
 */
public class HomeNetWorkDiskWebDAVResource implements WebResource {
     ...
     */
    public HomeNetWorkDiskWebDAVResource(String path, Folder folder) {
        this.path = path;
        this.folder = folder;
     ...
     */
    public HomeNetWorkDiskWebDAVResource(String path, Node node, File block) {
        this.path = path;
        this.node = node;
