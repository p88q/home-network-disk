package org.happy.homenetworkdisk.ui.module;
...
import org.happy.homenetworkdisk.ui.util.FilesTable;
 ...
 * @version 1.0
 */
public class FSViewer extends HomeNetWorkDiskDynamicWindow {
    ...
    private FSViewer() throws SQLException {
        ...
        window = new JDialog(ServerUIModule.window, "HomeNetWorkDisk-ROOT");
    ...
    private void getFolderView(String folderId) throws Exception {
        try {
            ...
            if (currentView != null && currentView.getCurrent() != null) {
                ...
                window.setTitle("HomeNetWorkDisk-" + currentView.getCurrent().getFolderName());
            } else {
                // 浏览一个不存在的文件夹时自动返回根目录
                getFolderView("root");
            }
     ...
     * </p>
     *
     * @return FSViewer 该视图的唯一实例，程序中只会存在一个该窗口。
     */
