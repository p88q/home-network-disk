...
/**
 * <h2>HomeNetWorkDisk窗口父类，所有窗口均应继承自该父类</h2>
 * <p>
 ...
 * @version 1.0
 */
public class HomeNetWorkDiskDynamicWindow {
    ...
    // 允许通过初始化配置文件动态修改分辨率
    public HomeNetWorkDiskDynamicWindow() {
     ...
     * <h2>获取基准分辨率-宽度</h2>
     * <p>
     * 该宽度为HomeNetWorkDisk开发时所使用的基准分辨率宽度。请以此宽度为基准进行窗口的设计。
     * </p>
     *
     * @return int 基准宽度-像素
     */
     ...
     * <h2>获取基准分辨率-高度</h2>
     * <p>
     * 该高度为HomeNetWorkDisk开发时所使用的基准分辨率宽度。请以此高度为基准进行窗口的设计。
     * </p>
     *
     * @return int 基准高度-像素
     */
